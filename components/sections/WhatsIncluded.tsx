...
export function WhatsIncluded() {
  ...
  return (
    <section id="included" className="py-20 md:py-32 px-6 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          {yes.map((item, i) => (
            <div
              key={i}
              className="flex gap-4 p-5 bg-[var(--surface)] border border-[var(--border)] rounded-2xl hover:bg-[var(--surface-elevated)] hover:border-[var(--border-strong)] transition-all duration-200"
            >
